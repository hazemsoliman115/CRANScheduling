...
#                print("Non-connected Nodes: ", [z.iden for z in fl.NonconnVNodes])
    ...
    plt.savefig('ThroughputOptHeuristInterval26102015.pdf', bbox_inches='tight')
    plt.savefig('ThroughputOptHeuristInterval26102015.eps', bbox_inches='tight')
    plt.figure(1)
    ...
    plt.savefig('ThroughputLossInterval26102015.pdf', bbox_inches='tight')
    plt.savefig('ThroughputLossInterval26102015.eps', bbox_inches='tight')
    plt.figure(2)
    ...
    plt.savefig('PercentThroughputLossInterval26102015.pdf', bbox_inches='tight')
    plt.savefig('PercentThroughputLossInterval26102015.eps', bbox_inches='tight')
#                
#        #for i in range(len(List_Flows)):
#            #print(List_Flows[i])
