# -*- coding: utf-8 -*-
"""
Created on Mon Jun 22 11:33:01 2015
...
#            print(A_ub)
    ...
    #plt.savefig('ThroughputOptHeuristLP26102015.pdf', bbox_inches='tight')
    #plt.savefig('ThroughputOptHeuristLP26102015.eps', bbox_inches='tight')
    plt.figure(1)
    ...
    #plt.savefig('ThroughputLoss26102015.pdf', bbox_inches='tight')
    #plt.savefig('ThroughputLoss26102015.eps', bbox_inches='tight')
    plt.figure(2)
    ...
    #plt.savefig('PercentThroughputLoss26102015.pdf', bbox_inches='tight')
    #plt.savefig('PercentThroughputLoss26102015.eps', bbox_inches='tight')
#                
#        #for i in range(len(List_Flows)):
#            #print(List_Flows[i])
