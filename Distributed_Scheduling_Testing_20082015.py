...
if __name__ == "__main__":
    ...
    #Num_Flows_List = [5]
    NumRes = 128
    clf_list = [svm.SVC(kernel='rbf', class_weight='auto', gamma=0, C=1), DecisionTreeClassifier(max_depth=5, class_weight={1: 70}), GaussianNB()]
    #clf_list = [LDA(), QDA(), GaussianNB(), linear_model.LogisticRegression(), KNeighborsClassifier(n_neighbors=3), DecisionTreeClassifier(max_depth=5), SVC(kernel="linear", C=0.025), SVC(gamma=2, C=1)]
